...
const EmptyState = () => (
  ...
  >
    ...
    <h3 className="text-xl font-bold mb-2">Featured Work Launching Soon</h3>
    <p className="text-sm text-ink/60">
      We're adding recent edits here. In the meantime, book a call and we'll walk you through examples directly.
    </p>
  </motion.div>
);
...
const VideoPortfolioGrid = ({ videos }: VideoPortfolioGridProps) => {
  if (videos.length === 0) {
    return <EmptyState />;
  }
